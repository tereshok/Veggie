...
class DynamicAdmin {
	 ...
	 * @param string | array $callback Function name that fills column with necessary data
	...
	public function addFeaturedImage( $post_type, $field_name = 'Featured Image' ) {
		$this->addField( $post_type, $this->featured_image_key, $field_name, array( $this, 'daThumbnailImage' ) );
	}
	...
	private function build_acf_columns() {
